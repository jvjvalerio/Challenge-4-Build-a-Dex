 ...
 */
export declare function useLayoutObservable<TOutput>(init: () => Observable<TOutput>): Observable<TOutput>;
/**
 ...
 */
export declare function useLayoutObservable<TOutput, TInputs extends Readonly<any[]>>(init: (inputs$: Observable<[...TInputs]>) => Observable<TOutput>, inputs: [...TInputs]): Observable<TOutput>;
