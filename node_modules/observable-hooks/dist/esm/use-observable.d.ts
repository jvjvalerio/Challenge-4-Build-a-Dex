 ...
 */
export declare function useObservable<TOutput>(init: () => Observable<TOutput>): Observable<TOutput>;
/**
 ...
 */
export declare function useObservable<TOutput, TInputs extends Readonly<any[]>>(init: (inputs$: Observable<[...TInputs]>) => Observable<TOutput>, inputs: [...TInputs]): Observable<TOutput>;
